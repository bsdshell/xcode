...
- (void)viewDidLoad
{
    ...
    [mybut setTitle:@"Slide Up" forState:(UIControlState) UIControlStateNormal];
...
{
    NSLog(@"Click Slide Up Button");
    
    SlideUpViewController* myViewController = [[SlideUpViewController alloc]init];
    myViewController.view.opaque = YES;
    myViewController.view.alpha = 0.5f;
    myViewController.view.backgroundColor = [UIColor brownColor];
    ...
    [self presentViewController:myViewController animated:YES completion:^{
        NSLog(@"Slide Up View Controller");
    }];
}
